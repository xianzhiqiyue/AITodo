...
from app.schemas import ParseAndCreateTaskResponse, ParseTaskResponse, TaskCreate, TaskDraft, TaskDraftOverride, TaskResponse
...
class ObsidianNativeTaskIntakeService:
    def __init__(self, *, write_service: ObsidianNativeTaskWriteService, parsing_service: TaskParsingService):
    ...
    async def parse_and_create(
        ...
        *,
        ...
        return ParseAndCreateTaskResponse(created=True, parse_result=parse_result, task=TaskResponse.model_validate(created))
    ...
    def _apply_override(self, draft: TaskDraft, override: TaskDraftOverride | None) -> TaskDraft:
        if override is None:
            return draft
        ...
        return TaskDraft(
            ...
            meta_data={**draft.meta_data, **(override.meta_data or {})} if "meta_data" in provided_fields else draft.meta_data,
        )
